  ...
  const loadEvents = useCallback(async () => {
    ...
    try {
      ...
      if (allEvents.length > 0) {
        ...
        // Demo mock events for tag UI preview (remove when Supabase is connected)
        const mockEvents: Event[] = [
          {
            id: 'mock-1',
            title: 'Base Builder Meetup',
            description: 'A community meetup for Base L2 builders. Come network, share ideas, and learn about the latest developments in the Base ecosystem.',
            date: '2026-03-15',
            time: '18:00',
            location: 'San Francisco, CA',
            creator: '0x1234567890abcdef1234567890abcdef12345678',
            attendees: ['0xaaa', '0xbbb', '0xccc'],
            maxAttendees: 50,
            tags: ['web3', 'base', 'networking', 'builders', 'defi'],
            category: 'Networking',
            isRecurring: false,
            status: 'upcoming',
          ...
          },
          {
            ...
            description: 'Discover digital art from emerging NFT artists on the Base network. Live minting, artist talks, and exclusive drops.',
            date: '2026-03-20',
            time: '14:00',
            location: 'New York, NY',
            creator: '0xabcdef1234567890abcdef1234567890abcdef12',
            attendees: ['0xddd', '0xeee'],
            maxAttendees: 100,
          ...
          {
            id: 'mock-3',
            title: 'DeFi Workshop: Yield Strategies',
            description: 'Learn about advanced yield farming strategies on Base. Hands-on workshop covering liquidity provision, staking, and portfolio management.',
            date: '2026-03-25',
            time: '10:00',
            location: 'Virtual',
            ...
            attendees: [],
            maxAttendees: 30,
            tags: ['defi', 'workshop', 'yield', 'education'],
            category: 'Education',
            isRecurring: false,
            status: 'upcoming',
            createdAt: new Date().toISOString(),
          ...
          {
            id: 'mock-4',
            title: 'Farcaster Social Hack Day',
            description: 'Build social apps on Farcaster and Base. Mini-hackathon with prizes and mentoring from core protocol developers.',
            date: '2026-04-01',
            time: '09:00',
            endTime: '17:00',
            location: 'Los Angeles, CA',
            creator: '0x1111222233334444555566667777888899990000',
            attendees: ['0xfff', '0x111', '0x222', '0x333', '0x444'],
            maxAttendees: 40,
            tags: ['hackathon', 'farcaster', 'social', 'builders'],
            category: 'Hackathon',
            isRecurring: false,
            status: 'upcoming',
            createdAt: new Date().toISOString(),
      ...
      // Show mock events when Supabase fails
      const mockEvents: Event[] = [
        {
          id: 'mock-1',
          title: 'Base Builder Meetup',
