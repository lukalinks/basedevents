...
-- This matches the Event interface exactly (camelCase fields)
...
-- ==============================================
-- EVENTS TABLE (matching Event interface exactly)
-- ==============================================
CREATE TABLE events (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
-- Trigger to automatically update updatedAt for events
...
INSERT INTO events (title, description, date, time, location, creator, tags, "maxAttendees") VALUES
