-- POA Database Setup Script
-- Run this in your Supabase SQL editor to create the POA tables

-- Create proof_of_attendance table
CREATE TABLE IF NOT EXISTS public.proof_of_attendance (
...
CREATE TABLE IF NOT EXISTS public.event_check_in_settings (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    event_id UUID NOT NULL REFERENCES public.events(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_proof_of_attendance_event_id ON public.proof_of_attendance(event_id);
CREATE INDEX IF NOT EXISTS idx_proof_of_attendance_attendee ON public.proof_of_attendance(attendee_address);
CREATE INDEX IF NOT EXISTS idx_proof_of_attendance_status ON public.proof_of_attendance(status);
CREATE INDEX IF NOT EXISTS idx_event_check_in_settings_event_id ON public.event_check_in_settings(event_id);
